...
func PeerConfig() config.GoShimmer {
	...
	c.DisabledPlugins = []string{"portcheck", "analysisClient", "profiling", "remotelog", "remotelogmetrics", "remotemetrics",
		"WebAPIMetricsEndpoint", "WebAPIEpochEndpoint", "ManaInitializer", "Warpsync"}
