...
func main() {
	...
	clients[0] = client.NewGoShimmerAPI(node1APIURL, client.SetHTTPClient(&http.Client{Timeout: 60 * time.Second}))
	clients[1] = client.NewGoShimmerAPI(node2APIURL, client.SetHTTPClient(&http.Client{Timeout: 60 * time.Second}))
