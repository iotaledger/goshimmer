...
//	GradeOfFinalityTime StrongParents WeakParents DislikeParents LikeParents StrongApprovers WeakApprovers CompressedBranchesID InclusionState Scheduled Booked
...
//	CompressedBranchesID,Conflicting,LazyBooked,GradeOfFinality,GradeOfFinalityTime
