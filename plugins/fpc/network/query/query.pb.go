...
type QueryReply_Opinion int32

const (
	QueryReply_DISLIKE   QueryReply_Opinion = 0
	QueryReply_LIKE      QueryReply_Opinion = 1
	QueryReply_UNDEFINED QueryReply_Opinion = 2
)

var QueryReply_Opinion_name = map[int32]string{
	0: "DISLIKE",
	1: "LIKE",
	2: "UNDEFINED",
}

var QueryReply_Opinion_value = map[string]int32{
	"DISLIKE":   0,
	"LIKE":      1,
	"UNDEFINED": 2,
}

func (x QueryReply_Opinion) String() string {
	return proto.EnumName(QueryReply_Opinion_name, int32(x))
}

func (QueryReply_Opinion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bf5d1f792f5992be, []int{1, 0}
}
...
type QueryReply struct {
	Opinion              []QueryReply_Opinion `protobuf:"varint,1,rep,packed,name=opinion,proto3,enum=query.QueryReply_Opinion" json:"opinion,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *QueryReply) GetOpinion() []QueryReply_Opinion {
	if m != nil {
		return m.Opinion
	}
	return nil
...
func init() {
	proto.RegisterEnum("query.QueryReply_Opinion", QueryReply_Opinion_name, QueryReply_Opinion_value)
...
var fileDescriptor_bf5d1f792f5992be = []byte{
	...
	,
}
