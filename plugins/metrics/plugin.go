...
func registerLocalMetrics() {
	...
	deps.GossipMgr.NeighborsEvents(gossip2.NeighborsGroupAuto).NeighborRemoved.Attach(onNeighborRemoved)
	deps.GossipMgr.NeighborsEvents(gossip2.NeighborsGroupAuto).NeighborAdded.Attach(onNeighborAdded)
