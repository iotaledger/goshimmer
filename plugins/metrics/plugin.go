...
func configure(plugin *node.Plugin) {
	...
	tangle.Instance.Events.TransactionAttached.Attach(events.NewClosure(func(transaction *message.CachedMessage, metadata *transactionmetadata.CachedMessageMetadata) {
		transaction.Release()
		metadata.Release()
