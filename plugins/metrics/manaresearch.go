...
var (
	...
	accessResearchMap manamodels.IssuerMap
	...
	// mapping nodeID -> mana value
	consensusResearchMap manamodels.IssuerMap
	// mutex to protect the map
...
func AccessResearchManaMap() manamodels.IssuerMap {
	accessResearchLock.RLock()
	defer accessResearchLock.RUnlock()
...
func ConsensusResearchManaMap() manamodels.IssuerMap {
	consensusResearchLock.RLock()
	defer consensusResearchLock.RUnlock()
	result := manamodels.IssuerMap{}
...
func measureAccessResearchMana() {
	...
	accessResearchMap, _, _ = manaPlugin.GetManaMap(manamodels.ResearchAccess)
...
func measureConsensusResearchMana() {
	...
	consensusResearchMap, _, _ = manaPlugin.GetManaMap(manamodels.ResearchConsensus)
