...
type ParametersDefinition struct {
	...
	Pollen struct {
		// InstanceID defines the config flag of the DRNG intanceID.
		InstanceID int `name:"intanceID" default:"1" usage:"instance ID of the GoShimmer drng instance"`
	...
	XTeam struct {
		// InstanceID defines the config flag of the DRNG intanceID.
		InstanceID int `name:"intanceID" default:"1339" usage:"instance ID of the x-team drng instance"`
	...
	Custom struct {
		// InstanceID defines the config flag of the DRNG intanceID.
		InstanceID int `name:"intanceID" default:"9999" usage:"instance ID of the custom drng instance"`
