...
var NewEvents = event.LinkableConstructor(func() (self *ManaEvents) {
	return &ManaEvents{
		Pledged: event.NewLinkable[*PledgedEvent, ManaEvents](),
		Revoked: event.NewLinkable[*RevokedEvent, ManaEvents](),
		Updated: event.NewLinkable[*UpdatedEvent, ManaEvents](),
	}
})
