...
func TestGadget_update_conflictsStepwise(t *testing.T) {
		...
		WithTangleOptions(
			tangle.WithBookerOptions(
				booker2.WithMarkerManagerOptions(
					markermanager.WithSequenceManagerOptions[models2.BlockID, *booker2.Block](markers2.WithMaxPastMarkerDistance(3)),
				),
			),
		),
	)
	...
	initialAcceptedMarkers := make(map[markers2.Marker]bool)
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(0, 1): false,
	}))
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(0, 1): true,
		markers2.NewMarker(0, 3): false,
	}))
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(0, 2): true,
		markers2.NewMarker(0, 4): false,
	}))
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(0, 3): true,
		markers2.NewMarker(0, 5): false,
	}))
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(0, 6): true,
		markers2.NewMarker(0, 7): false,
	}))
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(2, 6): true,
		markers2.NewMarker(2, 8): false,
	}))
	...
	tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
		markers2.NewMarker(2, 7): true,
		markers2.NewMarker(2, 8): true,
		markers2.NewMarker(2, 9): false,
	}))
...
func TestGadget_update_multipleSequences(t *testing.T) {
	...
	tf := NewTestFramework(t, WithGadgetOptions(WithMarkerAcceptanceThreshold(0.66)), WithTangleOptions(tangle.WithBookerOptions(booker2.WithMarkerManagerOptions(markermanager.WithSequenceManagerOptions[models2.BlockID, *booker2.Block](markers2.WithMaxPastMarkerDistance(3))))))
...

	{
		...
		tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
			...
			markers2.NewMarker(1, 5): false,
			markers2.NewMarker(1, 6): false,
			markers2.NewMarker(1, 7): false,
			markers2.NewMarker(2, 8): false,
			markers2.NewMarker(2, 5): false,
			markers2.NewMarker(2, 6): false,
			markers2.NewMarker(2, 7): false,
		}))
	...
	tf.IssueBlocks("Block17").WaitUntilAllTasksProcessed()
	{
		...
		tf.ValidateAcceptedMarker(lo.MergeMaps(initialAcceptedMarkers, map[markers2.Marker]bool{
			markers2.NewMarker(1, 5): true,
			markers2.NewMarker(1, 6): true,
			markers2.NewMarker(1, 7): true,
			markers2.NewMarker(1, 8): false,
		}))
