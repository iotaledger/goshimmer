...
func TestTipManager_TimeSinceConfirmation_Unconfirmed(t *testing.T) {
	tf := NewTestFramework(t,
		...
		WithTangleOptions(tangle.WithBookerOptions(booker2.WithMarkerManagerOptions(markermanager.WithSequenceManagerOptions[models2.BlockID, *booker2.Block](markers2.WithMaxPastMarkerDistance(10))))),
	)
...
func TestTipManager_TimeSinceConfirmation_Confirmed(t *testing.T) {
	...
	acceptedMarkers := []markers2.Marker{markers2.NewMarker(0, 1), markers2.NewMarker(1, 2), markers2.NewMarker(2, 3)}
