...
func TestScenario_1(t *testing.T) {
	...
	tf.CreateBlock("Block1", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX1", 3, "Genesis")))
	tf.CreateBlock("Block2", models2.WithStrongParents(tf.BlockIDs("Genesis", "Block1")), models2.WithPayload(tf.CreateTransaction("TX2", 1, "TX1.1", "TX1.2")))
	tf.CreateBlock("Block3", models2.WithStrongParents(tf.BlockIDs("Block1", "Block2")), models2.WithPayload(tf.Transaction("TX2")))
	tf.CreateBlock("Block4", models2.WithStrongParents(tf.BlockIDs("Genesis", "Block1")), models2.WithPayload(tf.CreateTransaction("TX3", 1, "TX1.0")))
	tf.CreateBlock("Block5", models2.WithStrongParents(tf.BlockIDs("Block1", "Block2")), models2.WithPayload(tf.CreateTransaction("TX4", 1, "TX1.0")))
	tf.CreateBlock("Block6", models2.WithStrongParents(tf.BlockIDs("Block2", "Block5")), models2.WithPayload(tf.CreateTransaction("TX5", 1, "TX2.0", "TX4.0")))
	tf.CreateBlock("Block7", models2.WithStrongParents(tf.BlockIDs("Block4", "Block5")), models2.WithPayload(tf.Transaction("TX2")))
	tf.CreateBlock("Block8", models2.WithStrongParents(tf.BlockIDs("Block4", "Block5")), models2.WithPayload(tf.CreateTransaction("TX6", 1, "TX3.0", "TX4.0")))
	tf.CreateBlock("Block9", models2.WithStrongParents(tf.BlockIDs("Block4", "Block6")), models2.WithPayload(tf.CreateTransaction("TX7", 1, "TX5.0")))
...
func TestScenario_2(t *testing.T) {
	...
	tf.CreateBlock("Block4", models2.WithStrongParents(tf.BlockIDs("Genesis", "Block1")), models2.WithPayload(tf.CreateTransaction("TX3", 1, "TX1.0")))
	tf.CreateBlock("Block5", models2.WithStrongParents(tf.BlockIDs("Block1", "Block2")), models2.WithPayload(tf.CreateTransaction("TX4", 1, "TX1.0")))
	tf.CreateBlock("Block6", models2.WithStrongParents(tf.BlockIDs("Block2", "Block5")), models2.WithPayload(tf.CreateTransaction("TX5", 1, "TX4.0", "TX2.0")))
	tf.CreateBlock("Block7", models2.WithStrongParents(tf.BlockIDs("Block1", "Block4")), models2.WithPayload(tf.CreateTransaction("TX6", 1, "TX1.2")))
	tf.CreateBlock("Block8", models2.WithStrongParents(tf.BlockIDs("Block7", "Block4")), models2.WithPayload(tf.CreateTransaction("TX7", 1, "TX3.0", "TX6.0")))
	tf.CreateBlock("Block9", models2.WithStrongParents(tf.BlockIDs("Block4", "Block7")), models2.WithPayload(tf.CreateTransaction("TX8", 1, "TX1.1")))
	tf.CreateBlock("Block0.5", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX9", 1, "TX8.0")))
...
func TestScenario_3(t *testing.T) {
	...
	tf.CreateBlock("Block3", models2.WithStrongParents(tf.BlockIDs("Block1", "Block2")), models2.WithPayload(tf.Transaction("TX2")))
	tf.CreateBlock("Block4", models2.WithStrongParents(tf.BlockIDs("Genesis", "Block1")), models2.WithPayload(tf.CreateTransaction("TX3", 1, "TX1.0")))
	tf.CreateBlock("Block5", models2.WithStrongParents(tf.BlockIDs("Block1")), models2.WithWeakParents(tf.BlockIDs("Block2")), models2.WithPayload(tf.CreateTransaction("TX4", 1, "TX1.0")))
	tf.CreateBlock("Block6", models2.WithStrongParents(tf.BlockIDs("Block2", "Block5")), models2.WithPayload(tf.CreateTransaction("TX5", 1, "TX4.0", "TX2.0")))
	tf.CreateBlock("Block7", models2.WithStrongParents(tf.BlockIDs("Block1", "Block4")), models2.WithPayload(tf.CreateTransaction("TX6", 1, "TX1.2")))
	tf.CreateBlock("Block8", models2.WithStrongParents(tf.BlockIDs("Block4", "Block7")), models2.WithPayload(tf.CreateTransaction("TX7", 1, "TX6.0", "TX3.0")))
	tf.CreateBlock("Block9", models2.WithStrongParents(tf.BlockIDs("Block4", "Block7")), models2.WithPayload(tf.CreateTransaction("TX8", 1, "TX1.1")))
...
func TestScenario_4(t *testing.T) {
	tf := NewTestFramework(t, WithBookerOptions(WithMarkerManagerOptions(markermanager.WithSequenceManagerOptions[models2.BlockID, *Block](markers2.WithMaxPastMarkerDistance(3)))))

	tf.CreateBlock("Block0", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX0", 4, "Genesis")))
	tf.IssueBlocks("Block0").WaitUntilAllTasksProcessed()

	markersMap := make(map[string]*markers2.Markers)
	metadataDiffConflictIDs := make(map[string][]utxo.TransactionIDs)
	conflictIDs := make(map[string]utxo.TransactionIDs)

	// ISSUE Block1
	{
		tf.CreateBlock("Block1", models2.WithStrongParents(tf.BlockIDs("Block0")), models2.WithPayload(tf.CreateTransaction("TX1", 1, "TX0.0")))
		tf.IssueBlocks("Block1").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block0": markers2.NewMarkers(markers2.NewMarker(0, 1)),
			"Block1": markers2.NewMarkers(markers2.NewMarker(0, 2)),
		}))
	...
	// ISSUE Block2
	{
		...
		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block2": markers2.NewMarkers(markers2.NewMarker(0, 3)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
	...
	// ISSUE Block3
	{
		tf.CreateBlock("Block3", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX3", 1, "TX0.1")))
		tf.IssueBlocks("Block3").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block3": markers2.NewMarkers(markers2.NewMarker(0, 0)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
	...
	// ISSUE Block4
	{
		tf.CreateBlock("Block4", models2.WithStrongParents(tf.BlockIDs("Block3")), models2.WithPayload(tf.CreateTransaction("TX4", 1, "TX0.0")))
		tf.IssueBlocks("Block4").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block4": markers2.NewMarkers(markers2.NewMarker(0, 0)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
	...
	// ISSUE Block5
	{
		...
		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block5": markers2.NewMarkers(markers2.NewMarker(1, 1)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
	...
	// ISSUE Block6
	{
		tf.CreateBlock("Block6", models2.WithStrongParents(tf.BlockIDs("Block5", "Block0")), models2.WithPayload(tf.CreateTransaction("TX5", 1, "TX0.2")))
		tf.IssueBlocks("Block6").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block6": markers2.NewMarkers(markers2.NewMarker(1, 2)),
		}))
	...
	// ISSUE Block6.3
	{
		tf.CreateBlock("Block6.3", models2.WithStrongParents(tf.BlockIDs("Block6")))
		tf.IssueBlocks("Block6.3").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block6.3": markers2.NewMarkers(markers2.NewMarker(1, 3)),
		}))
	...
	// ISSUE Block6.6
	{
		tf.CreateBlock("Block6.6", models2.WithStrongParents(tf.BlockIDs("Block6")))
		tf.IssueBlocks("Block6.6").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block6.6": markers2.NewMarkers(markers2.NewMarker(1, 2)),
		}))
	...
	// ISSUE Block7
	{
		tf.CreateBlock("Block7", models2.WithStrongParents(tf.BlockIDs("Block5", "Block0")), models2.WithPayload(tf.CreateTransaction("TX6", 1, "TX0.2")))
		tf.IssueBlocks("Block7").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block7": markers2.NewMarkers(markers2.NewMarker(1, 1), markers2.NewMarker(0, 1)),
		}))
	...
	// ISSUE Block7.3
	{
		tf.CreateBlock("Block7.3", models2.WithStrongParents(tf.BlockIDs("Block7")))
		tf.IssueBlocks("Block7.3").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block7.3": markers2.NewMarkers(markers2.NewMarker(1, 1), markers2.NewMarker(0, 1)),
		}))
	...
	// ISSUE Block7.6
	{
		tf.CreateBlock("Block7.6", models2.WithStrongParents(tf.BlockIDs("Block7.3")))
		tf.IssueBlocks("Block7.6").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block7.6": markers2.NewMarkers(markers2.NewMarker(2, 2)),
		}))
	...
	// ISSUE Block8
	{
		tf.CreateBlock("Block8", models2.WithStrongParents(tf.BlockIDs("Block2")), models2.WithPayload(tf.CreateTransaction("TX2", 1, "TX0.1")))
		tf.IssueBlocks("Block8").WaitUntilAllTasksProcessed()

		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block8": markers2.NewMarkers(markers2.NewMarker(0, 4)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
...
func TestFutureConePropagation(t *testing.T) {
	...
	tf.CreateBlock("Block1", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX1", 1, "Genesis")))
	tf.CreateBlock("Block1*", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX1*", 1, "Genesis")))
	tf.CreateBlock("Block2", models2.WithStrongParents(tf.BlockIDs("Block1")), models2.WithPayload(tf.CreateTransaction("TX2", 1, "TX1.0")))
	tf.CreateBlock("Block2*", models2.WithStrongParents(tf.BlockIDs("Block1")), models2.WithPayload(tf.CreateTransaction("TX2*", 1, "TX1.0")))

	// these are all liking TX1* -> should not have TX1 and TX2
	tf.CreateBlock("Block3", models2.WithStrongParents(tf.BlockIDs("Block2")), models2.WithLikedInsteadParents(tf.BlockIDs("Block1*"))) // propagation via markers
	tf.CreateBlock("Block4", models2.WithStrongParents(tf.BlockIDs("Block2")), models2.WithLikedInsteadParents(tf.BlockIDs("Block1*"))) // check correct booking (later)
	tf.CreateBlock("Block5", models2.WithStrongParents(tf.BlockIDs("Block2")), models2.WithLikedInsteadParents(tf.BlockIDs("Block1*"))) // propagation via individually mapped blocks
	tf.CreateBlock("Block6", models2.WithStrongParents(tf.BlockIDs("Block5")))                                                          // propagation via individually mapped blocks

	// these are liking TX1 -> should have TX2 too
	tf.CreateBlock("Block7", models2.WithStrongParents(tf.BlockIDs("Block2")))                                                         // propagation via individually mapped blocks
	tf.CreateBlock("Block8", models2.WithStrongParents(tf.BlockIDs("Block3")), models2.WithLikedInsteadParents(tf.BlockIDs("Block1"))) // propagation via marker
	tf.CreateBlock("Block9", models2.WithStrongParents(tf.BlockIDs("Block5")), models2.WithLikedInsteadParents(tf.BlockIDs("Block1"))) // propagation via marker
...

	{
		...
		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block1":  markers2.NewMarkers(markers2.NewMarker(0, 1)),
			"Block1*": markers2.NewMarkers(markers2.NewMarker(0, 0)),
			"Block2":  markers2.NewMarkers(markers2.NewMarker(0, 2)),
			"Block3":  markers2.NewMarkers(markers2.NewMarker(0, 3)),
			"Block5":  markers2.NewMarkers(markers2.NewMarker(0, 2)),
			"Block6":  markers2.NewMarkers(markers2.NewMarker(0, 2)),
			"Block7":  markers2.NewMarkers(markers2.NewMarker(0, 2)),
			"Block8":  markers2.NewMarkers(markers2.NewMarker(0, 4)),
			"Block9":  markers2.NewMarkers(markers2.NewMarker(0, 2)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
			"Block1":  {utxo.NewTransactionIDs(), utxo.NewTransactionIDs()},
	...
	// Verify correct propagation of TX2 to its future cone.
	{
		...
		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block2*": markers2.NewMarkers(markers2.NewMarker(0, 1)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
	...
	// Check that inheritance works as expected when booking Block4.
	{
		...
		tf.CheckMarkers(lo.MergeMaps(markersMap, map[string]*markers2.Markers{
			"Block4": markers2.NewMarkers(markers2.NewMarker(0, 2)),
		}))
		tf.checkBlockMetadataDiffConflictIDs(lo.MergeMaps(metadataDiffConflictIDs, map[string][]utxo.TransactionIDs{
...
func TestWeakParent(t *testing.T) {
	...
	tf.CreateBlock("Block1", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX1", 1, "Genesis")))
	tf.CreateBlock("Block1*", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("TX1*", 1, "Genesis")))
	tf.CreateBlock("Block2", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithWeakParents(tf.BlockIDs("Block1")))
...
func TestMultiThreadedBookingAndForkingParallel(t *testing.T) {
	...
	tf.CreateBlock("Block.G", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("G", layersNum, "Genesis")))
	...
	for layer := 0; layer < layersNum; layer++ {
		for width := 0; width < widthSize; width++ {
			...
			if input != "" {
				tf.CreateBlock(blkName, models2.WithStrongParents(tf.BlockIDs(strongParents...)), models2.WithPayload(tf.CreateTransaction(txAlias, 1, input)))
			} else {
				tf.CreateBlock(blkName, models2.WithStrongParents(tf.BlockIDs(strongParents...)))
			}
...
func TestMultiThreadedBookingAndForkingNested(t *testing.T) {
	...
	// Create base-layer outputs to double-spend
	tf.CreateBlock("Block.G", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithPayload(tf.CreateTransaction("G", widthSize, "Genesis")))
	tf.IssueBlocks("Block.G").WaitUntilAllTasksProcessed()
	...
	for layer := 0; layer < layersNum; layer++ {
		for width := 0; width < widthSize; width++ {
			...
			txAlias := fmt.Sprintf("TX.%d.%d", layer, width)
			tf.CreateBlock(blkName, models2.WithStrongParents(tf.BlockIDs(strongParents...)), models2.WithLikedInsteadParents(tf.BlockIDs(likeParents...)), models2.WithPayload(tf.CreateTransaction(txAlias, 1, input)))
...
func Test_Prune(t *testing.T) {
	...
	createNewBlock := func(idx int, prefix string) (block *models2.Block, alias string) {
		...
		if idx == 1 {
			...
			return tf.CreateBlock(
				...
				models2.WithPayload(tf.CreateTransaction(alias, 1, "Genesis")),
			), alias
		}
		parentAlias := fmt.Sprintf("blk%s-%d", prefix, idx-1)
		return tf.CreateBlock(
			alias,
			models2.WithStrongParents(tf.BlockIDs(parentAlias)),
			models2.WithIssuingTime(time.Unix(epoch.GenesisTime+int64(idx-1)*epoch.Duration, 0)),
			models2.WithPayload(tf.CreateTransaction(alias, 1, fmt.Sprintf("%s.0", parentAlias))),
		), alias
	}

	require.EqualValues(t, 0, tf.BlockDAG.EvictionManager.MaxEvictedEpoch(), "maxDroppedEpoch should be 0")
	...
	_, wasAttached, err := tf.BlockDAG.Attach(tf.CreateBlock(
		"blk-1-reattachment",
		models2.WithStrongParents(tf.BlockIDs(fmt.Sprintf("blk-%d", epochCount))),
		models2.WithIssuingTime(time.Unix(epoch.GenesisTime+int64(epochCount)*epoch.Duration, 0)),
		models2.WithPayload(tf.Transaction("blk-1")),
	))
	require.True(t, wasAttached, "block should be attached")
	require.NoError(t, err, "should not be able to attach a block after shutdown")
...
func Test_BlockInvalid(t *testing.T) {
	...
	tf.CreateBlock("Block1", models2.WithStrongParents(tf.BlockIDs("Genesis")))
	tf.CreateBlock("Block2", models2.WithStrongParents(tf.BlockIDs("Genesis")), models2.WithLikedInsteadParents(tf.BlockIDs("Block1")))
	tf.CreateBlock("Block3", models2.WithStrongParents(tf.BlockIDs("Block1", "Block2")))
	tf.CreateBlock("Block4", models2.WithStrongParents(tf.BlockIDs("Genesis", "Block1")))
	tf.CreateBlock("Block5", models2.WithStrongParents(tf.BlockIDs("Block1", "Block2")))
	tf.CreateBlock("Block6", models2.WithStrongParents(tf.BlockIDs("Block2", "Block5")))
	tf.CreateBlock("Block7", models2.WithStrongParents(tf.BlockIDs("Block4", "Block5")))
	tf.CreateBlock("Block8", models2.WithStrongParents(tf.BlockIDs("Block4", "Block5")))
	tf.CreateBlock("Block9", models2.WithStrongParents(tf.BlockIDs("Block4", "Block6")))
