...
func TestEngine_NonEmptyInitialValidators(t *testing.T) {
	...
	workers := workerpool.NewGroup(t.Name())
	tf := engine.NewDefaultTestFramework(t, workers.CreateGroup("EngineTestFramework"), clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engine.WithLedgerOptions(ledger.WithVM(ledgerVM)))
...
func TestEngine_BlocksForwardAndRollback(t *testing.T) {
	...
	// Dump snapshot for latest committable slot 4 and check engine equivalence
	{
		...
		tf2 := engine.NewDefaultTestFramework(t, workers.CreateGroup("EngineTestFramework2"), clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engine.WithLedgerOptions(ledger.WithVM(ledgerVM)))
	...
	// Dump snapshot for slot 1 and check attestations equivalence
	{
		...
		tf3 := engine.NewDefaultTestFramework(t, workers.CreateGroup("EngineTestFramework3"), clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engine.WithLedgerOptions(ledger.WithVM(ledgerVM)))
	...
	// Dump snapshot for slot 2 and check equivalence.
	{
		...
		tf4 := engine.NewDefaultTestFramework(t, workers.CreateGroup("EngineTestFramework4"), clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engine.WithLedgerOptions(ledger.WithVM(ledgerVM)))
...
func TestEngine_TransactionsForwardAndRollback(t *testing.T) {
	...
	engine1 := engine.NewTestEngine(t, workers.CreateGroup("Engine1"), engine1Storage, clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engineOpts...)
...

	{
		...
		tf2 := engine.NewDefaultTestFramework(t, workers.CreateGroup("EngineTestFramework2"), clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engineOpts...)
...

	{
		...
		engine3 := engine.NewTestEngine(t, workers.CreateGroup("Engine3"), engine3Storage, clock.Provide(), dpos.NewProvider(), mana1.NewProvider(), slotTimeProvider, engineOpts...)
...
func TestEngine_GuavaConflict(t *testing.T) {
	...
	workers := workerpool.NewGroup(t.Name())
	tf := engine.NewDefaultTestFramework(t, workers.CreateGroup("EngineTestFramework"), clock.Provide(), dpos.NewProvider(), mana1.NewProvider(),
		slotTimeProvider,
		engine.WithTangleOptions(
			tangle.WithBookerOptions(
				booker.WithMarkerManagerOptions(
