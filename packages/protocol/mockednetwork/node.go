...
func (n *Node) attachEngineLogs(instance *enginemanager.EngineInstance) {
	...
	events.Tangle.Booker.VirtualVoting.SequenceTracker.VotersUpdated.Hook(func(event *sequencetracker.VoterUpdatedEvent) {
	...
	events.Clock.AcceptanceTimeUpdated.Hook(func(newTime, now time.Time) {
