...
func TestScenario_4(t *testing.T) {
	tf := NewTestFramework(t, WithBookerOptions(WithMarkerManagerOptions(markermanager.WithSequenceManagerOptions[models2.BlockID, *Block](markers.WithMaxPastMarkerDistance(3)))))
