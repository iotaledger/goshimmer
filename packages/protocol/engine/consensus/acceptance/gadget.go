...
func New(tangle *tangle.Tangle, evictionState *eviction.State, opts ...options.Option[Gadget]) (gadget *Gadget) {
...
func (a *Gadget) propagateAcceptance(marker markers.Marker) (queuedBlocks []*Block) {
