...
func New(
	...
	clockProvider module.Provider[*Engine, Clock],
...
func (e *Engine) IsBootstrapped() (isBootstrapped bool) {
	...
	if isBootstrapped = time.Since(e.Clock.Acceptance().RelativeTime()) < e.optsBootstrappedThreshold && e.NotarizationManager.IsFullyCommitted(); isBootstrapped {
...
func (e *Engine) IsSynced() (isBootstrapped bool) {
	return e.IsBootstrapped() && time.Since(e.Clock.Acceptance().Time()) < e.optsBootstrappedThreshold
}
...
func (e *Engine) initNotarizationManager() {
	...
	e.Events.Clock.AcceptanceTimeAnchorUpdated.Hook(e.NotarizationManager.SetAcceptanceTime, event.WithWorkerPool(wpCommitments))
}
