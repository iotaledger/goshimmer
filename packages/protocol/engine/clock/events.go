...
type Events struct {
	...
	AcceptanceTimeUpdated *event.Linkable[*TimeUpdate, Events, *Events]

	// AcceptanceTimeUpdated is triggered when a Acceptance Tangle Time advances.
	ConfirmedTimeUpdated *event.Linkable[*TimeUpdate, Events, *Events]
...
var NewEvents = event.LinkableConstructor(func() (newEvents *Events) {
	return &Events{
		ConfirmedTimeUpdated:  event.NewLinkable[*TimeUpdate, Events, *Events](),
		AcceptanceTimeUpdated: event.NewLinkable[*TimeUpdate, Events, *Events](),
	}
})
