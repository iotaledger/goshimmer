...
func (b *BlockDAG) orphanageUpdaters(orphaned bool) (updateEvent *event.Event[*Block], updateFunc func(*Block, models2.BlockIDs) (bool, bool)) {
	if !orphaned {
...
func (b *BlockDAG) propagateOrphanageUpdate(blocks []*Block, orphanedBlocks models2.BlockIDs, updateEvent *event.Event[*Block], updateFunc func(*Block, models2.BlockIDs) (bool, bool)) {
