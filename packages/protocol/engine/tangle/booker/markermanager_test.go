...
func Test_PruneMarkerBlockMapping(t *testing.T) {
	...
	markerBlockMapping := make(map[markers2.Marker]*Block, epochCount)
...
func verifySequence(t *testing.T, markerManager *MarkerManager, sequenceID markers2.SequenceID, pruningEpoch, epochCount, sequenceCount, totalSequences int, permanentSequenceID ...markers2.SequenceID) {
...
func validateBlockMarkerMappingPruning(t *testing.T, markerBlockMapping map[markers2.Marker]*Block, markerManager *MarkerManager, prunedEpochs int) {
