...
func TestInheritancePrecedence(t *testing.T) {
	...
	tf.BlockDAG.CreateBlock("23K", models.WithPayload(tf.Ledger.CreateTransaction("23K_TX", 1, "Genesis")))
	tf.BlockDAG.CreateBlock("23K_Vote1", models.WithStrongParents(tf.BlockDAG.BlockIDs("23K")))
	tf.BlockDAG.CreateBlock("23K_Vote2", models.WithStrongParents(tf.BlockDAG.BlockIDs("23K")))
	tf.BlockDAG.IssueBlocks("23K", "23K_Vote1", "23K_Vote2")
	tf.BlockDAG.CreateBlock("8be", models.WithPayload(tf.Ledger.CreateTransaction("8be_TX", 1, "Genesis")))
	tf.BlockDAG.IssueBlocks("8be")

	fmt.Println("================================")
	fmt.Println(tf.Block("23K_Vote2"))

	tf.BlockDAG.CreateBlock("Gpo", models.WithStrongParents(tf.BlockDAG.BlockIDs("8be", "23K_Vote2")), models.WithLikedInsteadParents(tf.BlockDAG.BlockIDs("23K")))
	tf.BlockDAG.IssueBlocks("Gpo")

	fmt.Println("================================")
	fmt.Println(tf.Block("Gpo"))

	tf.PreventNewMarkers(true)
	tf.BlockDAG.CreateBlock("Eom", models.WithStrongParents(tf.BlockDAG.BlockIDs("8be", "23K_Vote2")), models.WithLikedInsteadParents(tf.BlockDAG.BlockIDs("23K")))
	tf.BlockDAG.IssueBlocks("Eom")

	fmt.Println("================================")
	fmt.Println(tf.Block("Eom"))
	fmt.Println(tf.Instance.BlockConflicts(tf.Block("Eom")))

	tf.BlockDAG.CreateBlock("EY4", models.WithStrongParents(tf.BlockDAG.BlockIDs("Eom", "Gpo")), models.WithWeakParents(tf.BlockDAG.BlockIDs("8be")), models.WithPayload(tf.Ledger.CreateTransaction("EY4_TX", 1, "8be_TX.0")))
	tf.BlockDAG.IssueBlocks("EY4")
