...
func NewTestEngine(t *testing.T, workers *workerpool.Group, storage *storage.Storage, clock module.Provider[*Engine, clock.Clock], sybilProtection module.Provider[*Engine, sybilprotection.SybilProtection], throughputQuota module.Provider[*Engine, throughputquota.ThroughputQuota], slotTimeProvider *slot.TimeProvider, opts ...options.Option[Engine]) *Engine {
	e := New(workers.CreateGroup("Engine"), storage, clock, sybilProtection, throughputQuota, slotTimeProvider, opts...)
...
func NewDefaultTestFramework(t *testing.T, workers *workerpool.Group, clock module.Provider[*Engine, clock.Clock], sybilProtection module.Provider[*Engine, sybilprotection.SybilProtection], throughputQuota module.Provider[*Engine, throughputquota.ThroughputQuota], slotTimeProvider *slot.TimeProvider, optsEngine ...options.Option[Engine]) *TestFramework {
	engine := NewTestEngine(t, workers.CreateGroup("Engine"), blockdag.NewTestStorage(t, workers, database.WithDBProvider(database.NewDB)), clock, sybilProtection, throughputQuota, slotTimeProvider, optsEngine...)
