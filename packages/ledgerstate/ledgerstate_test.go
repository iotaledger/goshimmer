...
func TestLedgerstate_MergeToMaster(t *testing.T) {
	...
	// issue Transaction A
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["A"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
	...
	// issue Transaction B (conflicting with A)
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["B"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
	...
	// issue Transaction C
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["C"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
	...
	// issue Transaction D (conflicting with C)
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["D"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
	...
	// issue Transaction E (combining Branch A and C)
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["E"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
	...
	// issue Transaction F
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["F"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
	...
	// issue Transaction G
	{
		...
		solid, solidityType, err := ledgerstate.StoreTransaction(transactions["G"])
		require.NoError(t, err)
		assert.True(t, solid)
		assert.Equal(t, Solid, solidityType)
