...
type Events struct {
	VotersUpdated *event.LinkableCollectionEvent[*VoterUpdatedEvent, Events, *Events]
...
var NewEvents = event.LinkableCollectionConstructor[Events](func(e *Events) {
	e.VotersUpdated = event.NewLinkableCollectionEvent[*VoterUpdatedEvent](e, func(target *Events) { e.VotersUpdated.LinkTo(target.VotersUpdated) })
})
