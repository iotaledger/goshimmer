...
func TestApprovalWeightManager_updateConflictVoters(t *testing.T) {
	...
	{
		tf.VotesTracker.TrackVote(tf.ConflictIDs("Conflict4.1.2"), tf.Validator("validator1").ID(), mockVotePower{2})
	...
	{
		tf.VotesTracker.TrackVote(tf.ConflictIDs("Conflict1.1", "Conflict4.1.1"), tf.Validator("validator1").ID(), mockVotePower{1})
	...
	{
		tf.VotesTracker.TrackVote(tf.ConflictIDs("Conflict2"), tf.Validator("validator1").ID(), mockVotePower{3})
	...
	{
		tf.VotesTracker.TrackVote(tf.ConflictIDs("Conflict1.2", "Conflict4.1.2"), tf.Validator("validator2").ID(), mockVotePower{3})
	...
	{
		tf.VotesTracker.TrackVote(tf.ConflictIDs("Conflict3"), tf.Validator("validator2").ID(), mockVotePower{5})
