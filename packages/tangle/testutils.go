...
func newTestParentsDataMessage(payloadString string, strongParents, weakParents []MessageID) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, time.Now(), ed25519.PublicKey{}, nextSequenceNumber(), payload.NewGenericDataPayload([]byte(payloadString)), 0, ed25519.Signature{})
	return message
}
...
func newTestParentsDataMessageIssuer(payloadString string, strongParents, weakParents []MessageID, issuer ed25519.PublicKey) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, time.Now(), issuer, nextSequenceNumber(), payload.NewGenericDataPayload([]byte(payloadString)), 0, ed25519.Signature{})
	return message
}
...
func newTestParentsDataMessageTimestampIssuer(payloadString string, strongParents, weakParents []MessageID, issuer ed25519.PublicKey, timestamp time.Time) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, timestamp, issuer, nextSequenceNumber(), payload.NewGenericDataPayload([]byte(payloadString)), 0, ed25519.Signature{})
	return message
}
...
func newTestParentsDataWithTimestamp(payloadString string, strongParents, weakParents []MessageID, timestamp time.Time) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, timestamp, ed25519.PublicKey{}, nextSequenceNumber(), payload.NewGenericDataPayload([]byte(payloadString)), 0, ed25519.Signature{})
	return message
}

func newTestParentsPayloadMessage(p payload.Payload, strongParents, weakParents []MessageID) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, time.Now(), ed25519.PublicKey{}, nextSequenceNumber(), p, 0, ed25519.Signature{})
	return message
}
...
func newTestParentsPayloadMessageIssuer(p payload.Payload, strongParents, weakParents []MessageID, issuer ed25519.PublicKey) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, time.Now(), issuer, nextSequenceNumber(), p, 0, ed25519.Signature{})
	return message
}
...
func newTestParentsPayloadMessageTimestampIssuer(p payload.Payload, strongParents, weakParents []MessageID, issuer ed25519.PublicKey, timestamp time.Time) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, timestamp, issuer, nextSequenceNumber(), p, 0, ed25519.Signature{})
	return message
}
...
func newTestParentsPayloadWithTimestamp(p payload.Payload, strongParents, weakParents []MessageID, timestamp time.Time) *Message {
	message, _ := NewMessage(strongParents, weakParents, nil, nil, timestamp, ed25519.PublicKey{}, nextSequenceNumber(), p, 0, ed25519.Signature{})
	return message
}
