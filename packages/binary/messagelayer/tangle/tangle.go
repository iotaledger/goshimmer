...
func New(store kvstore.KVStore) (result *Tangle) {
	...
	result = &Tangle{
		...
		missingMessageStorage:  osFactory.New(PrefixMissingMessage, missingMessageFactory, objectstorage.CacheTime(cacheTime), objectstorage.LeakDetectionEnabled(false), objectstorage.LogStoreAccess("store.log")),
