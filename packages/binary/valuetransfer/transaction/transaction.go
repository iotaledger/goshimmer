...
// CachedTransaction is a wrapper for the object storage, that takes care of type casting the Metadata objects.
...
func (cachedTransaction *CachedTransaction) Unwrap() *Metadata {
