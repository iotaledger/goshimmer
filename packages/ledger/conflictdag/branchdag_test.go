...
func assertInclusionStates(t *testing.T, branchDAG *ConflictDAG, branchIDsMapping map[string]BranchID, expectedInclusionStates map[string]InclusionState) {
...
func createBranch(t *testing.T, branchDAG *ConflictDAG, branchAlias string, parents BranchIDs, conflictIDs ConflictIDs) BranchID {
