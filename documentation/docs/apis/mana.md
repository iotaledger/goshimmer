...
#### Client lib -  GetMana() with short node ID
...
| `accessTimestamp` | int64 | The timestamp of access mana updates.     |
| `consensus`   | [mana.NodeStr](#mana.nodestr) | A list of node that has access mana.     |
| `consensusTimestamp` | int64 | The timestamp of consensus mana updates.  |
...
|Return field | Type | Description|
|:-----|:------|:------|
| online  | [OnlineNodeStr](#onlinenodestr) | The access mana information of online nodes.   |
...
|Return field | Type | Description|
|:-----|:------|:------|
| online`  | [OnlineNodeStr](#onlinenodestr) | The consensus mana information of online nodes.   |
| `timestamp` | int64 | The timestamp of mana updates.  |
...
|Return field | Type | Description|
|:-----|:------|:------|
| nodes  | [mana.NodeStr](#mana.nodestr) | The N highest access mana nodes.   |
| timestamp | int64 | The timestamp of mana updates.  |
...
|Return field | Type | Description|
|:-----|:------|:------|
| `nodes`  | [mana.NodeStr](#mana.nodestr) | The N highest consensus mana nodes.   |
| `timestamp` | int64 | The timestamp of mana updates.  |
...
|Return field | Type | Description|
|:-----|:------|:------|
| consensus   | [mana.NodeStr](#mana.nodestr) | The consensus mana of nodes.     |
| timestamp | int64 | The timestamp of mana updates.  |
...
|Return field | Type | Description|
|:-----|:------|:------|
| logs   | map[string][EventLogsJSON](#eventlogsjson) | The consensus mana of nodes. The key of map is node ID.     |
...
|Return field | Type | Description|
|:-----|:------|:------|
| accessMana   | [AllowedPledge](#allowedpledge) | A list of nodes that allow to pledge access mana.     |
| consensusMana | [AllowedPledge](#allowedpledge) | A list of nodes that allow to pledge consensus mana.  |
...
|field | Type | Description|
|:-----|:------|:------|
| pledge  | [PledgedEventJSON](#pledgedeventjson) | Pledged event logs.   |
| revoke   | [RevokedEventJSON](#revokedeventjson) | Revoked event logs.     |
